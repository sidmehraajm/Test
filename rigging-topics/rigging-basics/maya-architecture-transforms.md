...
> Transform nodes are [**dagNodes** ](maya-architecture-transforms.md#dag-and-dag-hierarchy)that are used to group and transform other dagNodes. **All dagNodes that are not transform nodes in Maya must exist as a child of some transform node**.
>
>
>
